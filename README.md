...
#### Notes ####
Electricar is a mock business idea and is __NOT__ a licensed business. This idea is 100% original by Jerel Sim Hong Jie

## Website Pages
#### Responsive in Desktop view and Iphone 12 Pro(390 x 844)
...
- 12th November 2022
    ...
    - Begun working on the wireframe for my website
    - Obtained & organised necessary assets (product images, logos, colour scheme)
    - Researched on website components (navigation bar, footer)

- 13th November 2022
    - Set-up necessary folders and GitHub repository
    - Published website to GitHub Pages 
    - Finished prototyping with Adobe XD
    - Finished navigation bar
    - Finished Home page
    - Initialised CSS variables
    - Added a hamburger navigation menu for mobile view

- 14th November 2022
    - Finished about section
    - Finished CSS for the about page

- 15th November 2022
    - Finished popular section
    - Finished CSS for the popular page

- 18th November 2022
    - Finished features section
    - Finished CSS for the features section
...
- 21th November 2022
    ...
    - Finished CSS for the featured section
    - Begun working on my responsive for my website
    - Finished footer
    - Finished CSS for footer

- 23th November 2022
    - Finished my responsive for my Index.html
    - Created a new page Contact.HTML
    - Begun working on the CSS for contact form
    - Starting the responsive for contact page

- 24th November 2022
    - Validating my website and editing according to the validator comments
    - Implemented JS for the open and close animation

- 29th November 2022
    - Update 2 and 3 for ReadMe


- 30th November 2022
    - Edited the metaview code

- 2nd December 2022
    - Implemented the scroll review animation
    - Adding in a Subscribe to our mailing list section 
    - Finished CSS for Subscribe section
    - Improved on my Contact Us page
    - Update 4  for ReadMe
...
- 4th December 2022
    - Video walkthrough of my website.
